...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t, std::pair<EthernetAddress, size_t>> _ip2mac_;
    size_t _timer{0};
    std::map<uint32_t, size_t> _arp_flood;
    std::map<uint32_t, std::queue<IPv4Datagram>> _send_datagram_queue;
